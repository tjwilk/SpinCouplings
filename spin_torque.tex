...
\begin{figure}
\includegraphics[width = 0.5\textwidth]{magnetometer_sensitivity_el.pdf}
\includegraphics[width = 0.5\textwidth]{magnetometer_sensitivity_nucl.pdf}
...
Runs are for 24h, with sampling times of 3.2 s. Thus, for axion wavelengths longer than $3.2$s, the dark matter is best found by analyzing the difference between $\Delta \omega$ at different samples and looking for oscillation at sidebands set by the the dark matter frequency at $\Omega_{\bigoplus} \pm m_a$. For axion wavelengths shorter $3.2$s, it is best to look for sidebands at $\omega_{He} \pm m_a$ and $\omega_{Xe} \pm m_a$. 
...
As a result, we can search for dark matter by analyzing the frequency spectrum of the weighted frequency difference and searching for these sidebands. The 
